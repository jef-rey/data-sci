...
```{r}
#getting errors about the reported date into the correct format

#Traffic_crime$REPORTED_DATE <- as.POSIXct(parse_date_time(Traffic_crime$REPORTED_DATE, format = "%m/%d/%Y %h%M"))
